 ...
 *
 * Android 13+ - Has full support, the liquid effect is only rendered for these devices as it uses
 * RuntimeShader for the effect.
 * Android 12 - The [LiquidScope.refraction] and [LiquidScope.curve] values are ignored, but will render
 * the frost effect if provided along with a lightweight visual backup that draws a similar edge effect.
 * Android 11 and lower - The [LiquidScope.frost] is also ignored as there is no support for the RenderEffect.
